package com.kt.smp.stt.confidence.handler;
...
/**
 * @author jaime
 * @title SttConfidenceHandler
 * @see\n <pre>
 * </pre>
 * @since 2022-07-18
 */
@Slf4j
public class SttConfidenceHandler extends BaseTypeHandler<List<String>> {
    ...
    private List<String> convertToList(String s) {
        ...
        try {
            ...
            log.error("[SttConfidenceHandler] failed to convert string to list");
        }
